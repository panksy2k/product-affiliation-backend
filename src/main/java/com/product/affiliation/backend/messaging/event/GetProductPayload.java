...
public class GetProductPayload extends ProductPayload {
  ...
  public GetProductPayload(@JsonProperty Long id) {
    super(id);
  }
  ...
  public GetProductPayload(@JsonProperty("id") Long id, String name, URL affiliateURL, String productCondition, Double price, String warrantyValue,
  ...
  public static GetProductPayload withId(long id, GetProductPayload oldProduct) {
      GetProductPayload p = new GetProductPayload(id, oldProduct.getName(), oldProduct.getAffiliateURL(), oldProduct.getProductCondition(),
